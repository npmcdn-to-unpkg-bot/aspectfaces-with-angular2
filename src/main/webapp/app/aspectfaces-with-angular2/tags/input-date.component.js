    ...
    return {
        ...
        execute: function() {
            InputDateComponent = (function () {
                ...
                ], InputDateComponent.prototype, "fieldData", void 0);
                __decorate([
                    core_1.Input(), 
                    __metadata('design:type', Object)
                ], InputDateComponent.prototype, "values", void 0);
                __decorate([
                    core_1.Input(), 
                    __metadata('design:type', Boolean)
                ], InputDateComponent.prototype, "edit", void 0);
                InputDateComponent = __decorate([
                    core_1.Component({
                        selector: 'af-input-date',
            ...
            exports_1("InputDateComponent", InputDateComponent);
        }
    }
});
