    ...
    return {
        ...
        execute: function() {
            InputEmailComponent = (function () {
                ...
                ], InputEmailComponent.prototype, "fieldData", void 0);
                __decorate([
                    core_1.Input(), 
                    __metadata('design:type', Object)
                ], InputEmailComponent.prototype, "values", void 0);
                __decorate([
                    core_1.Input(), 
                    __metadata('design:type', Boolean)
                ], InputEmailComponent.prototype, "edit", void 0);
                InputEmailComponent = __decorate([
                    core_1.Component({
                        selector: 'af-input-email',
            ...
            exports_1("InputEmailComponent", InputEmailComponent);
        }
    }
});
