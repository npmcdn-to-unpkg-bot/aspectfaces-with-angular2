System.register(["angular2/core", "./tags/input-boolean.component", "./tags/input-date.component", "./tags/input-email.component", "./tags/input-password.component", "./tags/input-text.component"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, input_boolean_component_1, input_date_component_1, input_email_component_1, input_password_component_1, input_text_component_1;
    var FormComponent;
    return {
        setters:[
            function (core_1_1) {
            ...
            function (input_date_component_1_1) {
                input_date_component_1 = input_date_component_1_1;
            },
        ...
        execute: function() {
            FormComponent = (function () {
                ...
                FormComponent = __decorate([
                    core_1.Component({
                        directives: [input_boolean_component_1.InputBooleanComponent, input_date_component_1.InputDateComponent, input_email_component_1.InputEmailComponent, input_password_component_1.InputPasswordComponent, input_text_component_1.InputTextComponent],
                        selector: 'af-form',
